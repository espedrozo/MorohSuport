...
interface DeleteModalProps {
  index: number;
  handleDetelePostItem: () => void;
  handleChangeIdPostitem: (index: number) => void;
}

export function ModalDeletePostItem(
  {
    index,
    handleDetelePostItem,
    handleChangeIdPostitem,
  }: DeleteModalProps) {

  return (
    <AlertDialog>
      <AlertDialogTrigger asChild>
        <span onClick={() => handleChangeIdPostitem(index)}>
      ...
      <AlertDialogContent >
        ...
        <Flex css={{ justifyContent: 'center' }}>
          ...
          <AlertDialogAction asChild>
            <Button variant="red" onClick={() => handleDetelePostItem()}>Sim</Button>
          </AlertDialogAction>
        </Flex>
      </AlertDialogContent>
    </AlertDialog>
